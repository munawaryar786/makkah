import type { UmrahPackage } from "./umrahPackages";

export const seasonalOffers: UmrahPackage[] = [
  {
    slug: "seasonal-airsial-28-days-1448h",
    name: "28 Days Seasonal Umrah - AirSial",
    category: "Seasonal Umrah",
    departureCity: "Multan",
    duration: "28 Days",
    airline: "AirSial",
    badge: "Bumper Offer 1448H",
    flightSummary: "PF762 on 05 Jul 2026 MUX to MED, PF763 on 02 Aug 2026 MED to MUX.",
    travelWindow: "05 Jul to 02 Aug 2026",
    makkahHotel: "Fundaq Marzaim / Sharaq Hotel (Shuttle)",
  ...
  },
  {
    ...
    name: "21 Days Seasonal Umrah - airblue",
    category: "Seasonal Umrah",
    departureCity: "Multan",
    duration: "21 Days",
    airline: "airblue",
    badge: "Seasonal Offer 1448H",
    flightSummary: "06, 17, 24, 27 and 31 July MUX to JED departure windows.",
    travelWindow: "July to August 2026 windows",
